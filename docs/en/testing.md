...
Mutations are very straightforward to test, because they are just functions that completely rely on their arguments. One trick is that if you are using ES2015 modules and put your mutations inside your `index.js` file, in addition to the default export, you can also export the mutations as a named export:
